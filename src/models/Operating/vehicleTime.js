...
import { query,getCargoStatusurl,getLocHistoryurl ,getImg } from 'services/Operating/vehicleTime'
import { pageModel } from '../common'
const { prefix } = config
import { message} from 'antd'
import moment from 'moment';
export default modelExtend(pageModel, {
  namespace: 'operatingvehicleTime',
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/Operating/vehicleTime') {
