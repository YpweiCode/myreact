    ...
    return     <Modal {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label="所在园区" hasFeedback {...formItemLayout}>
          ...
          })(<Input maxLength="15" placeholder="所在园区"  onChange={getpark} />)}
        </FormItem>
        <div id="container2" style={{width:"80%",height:"260px",margin:"0 auto",marginBottom:"20px"}}></div>
        <FormItem label="货物品类" hasFeedback {...formItemLayout}>
          ...
          })(<Input maxLength="11" placeholder="货物种类"  />)}
        </FormItem>
        <FormItem label="体积(方)" hasFeedback {...formItemLayout}>
          {getFieldDecorator('volume', {
            initialValue: 1||item.volume,
            rules: [
              {
                required: true,
                message:"请输入体积(*大于零*)",
          ...
          })(<InputNumber min={1} placeholder="体积"  precision="2"  maxLength="8" max={10000000} />)}
        </FormItem>
        <FormItem label="重量(公斤)" hasFeedback {...formItemLayout}>
          {getFieldDecorator('weight', {
            initialValue: 1||item.weight,
            rules: [
              {
                required: true,
                message:"请输入重量(*大于零*)",
          ...
          })(<InputNumber min={1} precision="2" placeholder="重量"  maxLength="8" max={10000000} />)}
        </FormItem>
        <FormItem label="说明" hasFeedback {...formItemLayout}>
          ...
          })(<Input  maxLength="15" placeholder="备注"   style = {{ width: '100%'}}/>)}
        </FormItem>
      </Form>
    </Modal>
  }
