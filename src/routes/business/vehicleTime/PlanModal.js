...
class planModal extends Component {
  ...
  componentDidMount() {
    ...
    const mapLatLng = this.props.item.latLng;
    ...
    AMap.plugin(["AMap.Driving"], function() {
      ...
      //根据起终点坐标规划驾车路线
      driving.search([startPot.pickLng, startPot.pickLat], [endPot.sendLng, endPot.sendLat],function(status,result){
  ...
  render() {
    ...
    return (
      <Modal {...modalOpts}>
            ...
            <div id = 'trunkMap' style = {{width: '100%', border: '1px solid #eee', borderRadius: 2,  height: 300, margin:'5px 0px'}}></div>
      </Modal>
    )
  }
}
